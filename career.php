...
<html lang="en">
  ...
  <body>
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown active">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="active"><a href="career.php">Career Form</a></li>
                      </ul>
                    </li>
                </ul>
    ...
    <div id="en-header">
        <div class="container">
            <h2 class="pull-left">Careers and Opportunity</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="section-title text-left"> <!-- Left Section Title -->
                        <h2>Hiring! Mechanical Engineers</h2>
                        <h5><strong>120 Available Positions</strong></h5>
                        <hr>
                        <p>Quisque porttitor sem libero auctor lorem fringilla sit amehasellus gravida nisi elitam egestda. Sedquis viverra enim.</p>
                        
                        <div id="popup">
                            <a class="read-more" href="https://www.youtube.com/watch?v=L9szn1QQfas">Video about Life in Highground <span class="fa fa-chevron-circle-right"></span></a>
                        </div>
                    </div>
                    ...
                    <div class="position-details">
                        ...
                        <ul class="list-unstyled list-block">
                            <li><strong>Location: </strong> United Kingdom Branch</li>
                            <li><strong>Position: </strong> Senior Mechanical Engineer</li>
                            <li><strong>Contract: </strong> 3 Years Contract</li>
                            <li><strong>Monthly Salary: </strong> $5,000.00 - $10,000.00</li>
                        </ul>
                        <a class="read-more" href="#en-application">Apply Now <span class="fa fa-chevron-circle-right"></span></a>
                    </div>
                ...
                <div class="col-sm-8 col-md-8">
                    <p class="lead">Are you interested to be part of our excellent team? Highground is looking for Competent Mechanical Engineers.</p>
                    <p>Proin porta sem nisi, ut maximus erat efficitur veldere etm tempus mi. Sed sagittis malesuada laoreetem ipsumolor Lorem ipsum dolor sit amet, consectetur adipisng elit. Duis eu libero scelerisque ligula agittis faucibus eget quis lacususpendisse sodales sed orci ac feuconsectetur adipiscingituis eu libero scelerisque ligulac t neque led dolor.</p>
                    ...
                    <br>
                    <h4>Requirement and Qualifications</h4>
                    <ul class="list-unstyled list-block">
                        <li><i class="fa fa-check-square"></i>Sunt in culpa qui officia deserunt mollit anim id est</li>
                        <li><i class="fa fa-check-square"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
                        <li><i class="fa fa-check-square"></i>Excepteur sint occaecat cupidatat non sunt in culpa qui.</li>
    ...
    <div id="en-application">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="section-title text-left"> <!-- Left Section Title -->
                        <h2>Fill in the Form <br>to Apply</h2>
                        <hr>
                        <p>Are you interested to be part of our excellent team? Highground is looking for Competent Mechanical Engineers.</p>
                        <br>
                        <a class="read-more" href="about.php">Learn More About Us <span class="fa fa-chevron-circle-right"></span></a>
                    </div>
                </div>
                ...
                <div class="col-sm-8 col-md-8">
                    ...
                    <form id="application-form" class="form">
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="Your Name Fullname">
                            </div>
                            <div class="col-md-6">
                        ...
                        <textarea class="form-control" rows="6" placeholder="Tell Us Amazing about You..."></textarea>
                        <button type="submit" class="btn btn-default en-btn dark">Send Message</button>
                    </form>
