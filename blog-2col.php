                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown active">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="active"><a href="blog-2col.php">Blog - 2 Col</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="news"> <!-- Blog Post/News #3 -->
                                ...
                                <a href="single-blog.php"><h4>Sed vel malesuada ipsum ras pulvinar quam et justo luctusibused urna lorem euismod noi</h4></a>
                                <hr>
                                <p class="meta">
                                    <span class="meta-tags">
                                        <i class="fa fa-tags"></i> 
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                            <div class="news"> <!-- Blog Post/News #2 -->
                                <div class="featured-img">
                                    <img src="http://placehold.it/800x600" alt="..." class="img-responsive">
                                    <span class="meta-date"><i class="fa fa-calendar"></i> March 2, 2015</span>
                                </div>
                                <a href="single-blog.php"><h4>Construction Going Green - Green Architecture</h4></a>
                                <hr>
                                <p class="meta">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="news"> <!-- Blog Post/News #3 -->
                                <div class="featured-img">
                                    <img src="http://placehold.it/800x600" alt="..." class="img-responsive">
                                    <span class="meta-date"><i class="fa fa-calendar"></i> Feb 20, 2015</span>
                                </div>
                                <a href="single-blog.php"><h4>New Or Used Construction Equipment - The Return On Investment Decision</h4></a>
                                <hr>
                                <p class="meta">
